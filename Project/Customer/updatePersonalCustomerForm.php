...
$qry = getCustomerInformation($customerId);
$customerRecord = mysqli_fetch_assoc($qry);

$custName = $customerRecord['custName'];
...
echo '<div id ="set" style="line-height: 1.8;">';
    echo '<form action="processCustomer.php" method="POST">';
        echo '<fieldset class=" w3-border w3-round-xlarge w3-pale-red w3-border-red w3-margin w3-display-middle" style="width: 50%;top:55%"><legend>Customer Information:</legend>';
    
        echo "Customer ID:<br><input type='text' name='customerId' value='$customerId' readonly class='w3-input w3-border w3-round-large'>"; 
        echo "<br>Customer Name:<br><input type='text' name='custName' value='$custName' class='w3-input w3-border w3-round-large'>";  
        ...
        echo "<br><br><input type='submit' name='updateCustomerPersonalButton' value='Save' class='w3-button w3-red w3-round-xlarge 'style='margin:5px;'>";
