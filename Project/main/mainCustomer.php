...
if (!(isset($_SESSION['userId']) && $_SESSION['userId'] != '')) {
	header ("Location: ../login/loginCustomer.php");
}
  include "../Customer/customer.php";
  $userName = $_SESSION['userId'];    
  $curTime = $_SESSION['curTime'];
  $customerInfoRow = getCustomerInformation($userName);
  $customerInfoRow = $customerInfoRow->fetch_array(MYSQLI_ASSOC); //taak faham,
  
  echo '<h1>Welcome to UniRent Hub</h1>';
  
  echo "<h4><center>Welcome back  </h4></center><h5><center>".$customerInfoRow['custName'].'</center></h5>';
...
<ol>
  <li><a class=" w3-text-red "><b><a href="../Booking/bookFacilityForm.php">Book Facility</a></b></a></li>
  <li><a class=" w3-text-red "><b><a href="../Booking/bookingListForm.php">View Booking</a></b></a></li>
</ol>
